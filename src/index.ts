...
app.get('/.well-known/pki-validation/5F50110576AEA41DE62126CE8D01E9BB.txt', async (req: Request, res: Response) => {
  const result = await readFile(__dirname + '/5F50110576AEA41DE62126CE8D01E9BB.txt')
  res.send(result)
})
